...
@course_blueprints.route("/course/<string_course_id>/deparment/<string:department_id>", methods = ["PUT"] )
def assign_department (course_id, deparmet_id):
    response = course_controller.department_assign(course_id, deparmet_id)
    return response, 201
